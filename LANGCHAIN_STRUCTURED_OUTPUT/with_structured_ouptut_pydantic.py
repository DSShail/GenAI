...
class Review(BaseModel):
    ...
    sentiment  : Literal["pos","neg"] =Field(description="return sentiment of the review either postive, negative, neutral")
...
Review by Shailesh Kumar
             """)
'''
    The data type of result is dictionary because we are using with_structured_output
'''
print(result)
